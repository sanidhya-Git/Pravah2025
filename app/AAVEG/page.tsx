...
const CardSplit = () => {
  ...
  const cardsData = [
    {
      ...
      title: "Badminton",
      description:
        "Participate in the most exciting badminton event of the year and showcase your talent!",
    },
    {
      image:
        "https://media.newyorker.com/photos/65badc73c17031f273a94a9c/master/pass/240212_r43718.jpg",
      title: "Basketball",
      description:
        "Join the thrilling basketball matches and cheer for your favorite teams!",
    },
    {
      image:
        "https://images7.alphacoders.com/135/1351757.png",
      title: "Chess",
      description:
    ...
    {
      image:
        "https://149853888.v2.pressablecdn.com/wp-content/uploads/2020/04/carrom-390956_1920.jpg",
      title: "Carrom",
      description:
    ...
    {
      image:
        "https://c1.wallpaperflare.com/preview/317/826/447/dew-tug-of-war-drag-men.jpg",
      title: "Tug of War",
      description:
    ...
    {
      image:
        "https://wallpapers.com/images/featured/volleyball-6dvotamb3ddiy7qw.jpg",
      title: "Volleyball",
      description:
    ...
    {
      image:
        "https://wallpapers.com/images/featured/kabaddi-7awdb9vk9aw87dzo.jpg",
      title: "Kabaddi",
      description:
    ...
    {
      image:
        "https://t4.ftcdn.net/jpg/02/78/83/29/360_F_278832931_UkriA1OiuaLBvBZb88Rrbazl6pOfWiPq.jpg",
      title: "Weightlifting",
      description:
  ...
  return (
    <main id="main">
      ...
      <h1 className={`${fonts.funkyVibes.className} text-5xl font-bold mb-11`}>AAVEG'25</h1>
      <p className="title">
        Welcome to AAVEG'25!! One of the largest sports events in Jaipur is back with its 25th edition this February, that unites the vibrant spirit of the students through the thrill of sports. The annual sports fest of SKIT signifies a platform which encourages its participants to face challenges with courage, unwavering determination, perseverance and showcasing their sportsmanship. With an addition of celebrating the triumphs over setbacks. So get ready to feel the adrenaline rush over the thrilling faces and prove your mettle at the sports extravaganza.
      </p>
      <div ></div>
